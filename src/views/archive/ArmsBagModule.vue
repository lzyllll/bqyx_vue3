    ...
    <el-card class="module-card">
      <template #header>
        <div class="card-header">
          ...
          <div>
            <h2>武器背包</h2>
            <p class="module-desc">武器背包数据和装备信息</p>
          </div>
        </div>
      </template>
      
      <!-- 武器背包统计 -->
      <StatsCards :stats="armsBagStats" />
...
import { Box, Star, Lock } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
import type { ArmsBag, ArmSaveItem } from '@/types/archive/module/arms'
...
const data = computed((): ArmsBag | null => {
  return archiveStore.getModuleData('armsBag') as ArmsBag | null
})

// 武器背包统计
const armsBagStats = computed(() => {
