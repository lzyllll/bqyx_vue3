...
import type { Pet } from '@/types/archive/module/pet'
...
// 获取装备模块数据
const data = computed((): Pet | null => {
    return archiveStore.getModuleData('pet') as Pet | null
})


// 获取魂卡总属性加成
const getTotalCardBonus = () => {
    return getFormattedBonusList(data.value.getFightPet().getRoleBonus())
}
